...
export async function extractCustomerInvoiceVoice(
  ...
  form.append("audioDurationMillis", String(audioDurationMillis));
  form.append("currentProduct", currentProduct);
...
export type TenderCoconutPrefill = {
  experienceMode: "TENDER_COCONUT" | "QUICK_DETAILS";
...
export async function getCustomerTenderCoconutPrefill() {
  return customerRequest<TenderCoconutPrefill>({
    method: "GET",
    url: "/invoices/customer/tender-coconut/prefill",
  });
}
