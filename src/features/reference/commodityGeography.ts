...
export const STATES_BY_COMMODITY: Record<string, readonly string[]> = {
  ...
  MANGO: ["UTTAR_PRADESH", "MAHARASHTRA", "ANDHRA_PRADESH"],
  BANANA: ["TAMIL_NADU", "MAHARASHTRA", "GUJARAT"],
  KIWI: ["ARUNACHAL_PRADESH", "HIMACHAL_PRADESH", "UTTARAKHAND"],
  DRAGON_FRUIT: ["GUJARAT", "MAHARASHTRA", "KARNATAKA"],
  MOSAMBI: ["MAHARASHTRA", "ANDHRA_PRADESH", "TELANGANA"],
  GUAVA: ["UTTAR_PRADESH", "MAHARASHTRA", "BIHAR"],
  PEACHES: ["HIMACHAL_PRADESH", "JAMMU_AND_KASHMIR", "UTTARAKHAND"],
  PLUM: ["HIMACHAL_PRADESH", "JAMMU_AND_KASHMIR"],
  WATERMELON: ["UTTAR_PRADESH", "KARNATAKA", "RAJASTHAN"],
  PAPAYA: ["ANDHRA_PRADESH", "GUJARAT", "KARNATAKA"],
  ORANGE: ["MAHARASHTRA", "MADHYA_PRADESH", "PUNJAB"],
  ONION: ["MAHARASHTRA", "KARNATAKA", "MADHYA_PRADESH"],
  POTATO: ["UTTAR_PRADESH", "WEST_BENGAL", "BIHAR"],
  GINGER: ["KARNATAKA", "ASSAM", "MEGHALAYA"],
};
