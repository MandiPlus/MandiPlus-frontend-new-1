...
export const ADMIN_NAV_ITEMS: AdminNavItem[] = [
  ...
  },
  {
    ...
    icon: UserCircleIcon,
    section: "app-customers",
  },
  {
    name: "Account Memberships",
    href: "/admin/account-memberships",
    icon: LinkIcon,
    section: "account-memberships",
  },
  {
    name: "Invoices",
    href: "/admin/app-invoices",
    icon: DevicePhoneMobileIcon,
    section: "app-invoices",
  },
  {
    name: "Quick Details",
    href: "/admin/quick-details",
    icon: InboxArrowDownIcon,
    section: "app-quick-details",
  },
  {
    name: "Payments",
    href: "/admin/app-payments",
    icon: CreditCardIcon,
    section: "app-payments",
  },
  {
    name: "Coupons",
  ...
  },
  {
    ...
    icon: BanknotesIcon,
    section: "agent-commissions",
  },
  {
    name: "Insurance Payments",
    href: "/admin/insurance-payments",
    icon: CreditCardIcon,
    section: "insurance-payments",
  },
  {
    name: "Arrival Reports",
    href: "/admin/arrival-reports",
    icon: DocumentChartBarIcon,
    section: "arrival-reports",
  },
  {
  ...
  },
  {
    ...
    href: "/admin/invoice-tracking",
    icon: PaperAirplaneIcon,
    section: "invoice-tracking",
  },
  {
    name: "Insurance Learning",
    href: "/admin/insurance-learning",
    icon: SparklesIcon,
    section: "insurance-learning",
  },
  {
  ...
  {
    name: "Access Monitor",
    href: "/admin/access-monitor",
    icon: ShieldCheckIcon,
    section: "access-monitor",
  },
  {
    name: "Team Daily Logs",
    href: "/admin/team-logs",
