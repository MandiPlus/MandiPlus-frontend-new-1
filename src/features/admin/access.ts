...
export const ADMIN_NAV_ITEMS: AdminNavItem[] = [
  ...
  { name: 'App Config', href: '/admin/app/configs', icon: Cog6ToothIcon, section: 'app-settings' },
  { name: 'ULIP API Test', href: '/admin/app/ulip-api-test', icon: ShieldCheckIcon, section: 'app-settings' },
  ...
  { name: 'Overload', href: '/admin/invoices/overload', icon: ScaleIcon, section: 'insurance-forms' },
  ...
  { name: 'RC Search', href: '/admin/operations/rc-search', icon: MagnifyingGlassIcon, section: 'rc-search' },
...
export const ADMIN_NAV_GROUPS: AdminNavGroup[] = [
  ...
  {
    name: 'Operations',
    sections: ['tracking', 'trips', 'fasttag', 'tracking-children', 'rc-search', 'arrival-reports', 'field-operations', 'fssai-leads'],
  },
  {
...
export const ADMIN_ROUTE_SECTION_MAP: Record<string, AdminSection> = {
  ...
  '/admin/operations/rc-search': 'rc-search',
