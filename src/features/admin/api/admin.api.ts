...
class AdminApi {
  ...
  public createAdminInvoice = async (
    ...
    try {
      ...
      if (payload.supplierState) formData.append("supplierState", payload.supplierState);
      if (payload.supplierDistrict) formData.append("supplierDistrict", payload.supplierDistrict);
      if (payload.supplierMandi) formData.append("supplierMandi", payload.supplierMandi);
      ...
      if (payload.buyerState) formData.append("buyerState", payload.buyerState);
      if (payload.buyerDistrict) formData.append("buyerDistrict", payload.buyerDistrict);
      if (payload.buyerMandi) formData.append("buyerMandi", payload.buyerMandi);
